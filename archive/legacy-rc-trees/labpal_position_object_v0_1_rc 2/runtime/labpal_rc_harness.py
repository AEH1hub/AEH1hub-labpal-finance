...
position_schema = load(ROOT / "position-object-v0.1-rc.schema.json")
event_schema = load(ROOT / "event-model" / "event-model-v0.1-rc-b4.schema.json")
claim_schema = load(ROOT / "event-model" / "claim-v0.1-rc-b4.schema.json")
...
def main():
    ...
    claims = load(ROOT / "event-model" / "claims.fixture.json")
    events = load(ROOT / "event-model" / "events.fixture.json")
